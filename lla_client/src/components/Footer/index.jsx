    ...
    <footer className="text-gray-600 body-font dark:bg-slate-900 dark:text-white">
      ...
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a className="ml-3 text-gray-500 hover:text-blue-600 dark:hover:text-blue-600 dark:text-white">
            <svg
              fill="currentColor"
              strokeLinecap="round"
          ...
          <a className="ml-3 text-gray-500 hover:text-purple-600 dark:hover:text-purple-600 dark:text-white">
            <svg
              fill="none"
              stroke="currentColor"
              strokeLinecap="round"
          ...
          <a className="ml-3 text-gray-500 dark:text-white dark:hover:text-blue-400 hover:text-blue-400 ">
            <svg
              fill="currentColor"
              stroke="currentColor"
              strokeLinecap="round"
