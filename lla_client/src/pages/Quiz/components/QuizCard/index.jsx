      ...
      <div className="container mx-auto flex flex-col px-5 py-12 pb-2 justify-center items-center h-3/5 bg-gray-100 dark:bg-slate-900 dark:text-white">
        ...
        <div className="w-full flex flex-col mb-16 items-center text-center">
          ...
          <div className="  flex-wrap mx-5">
            <button className="mt-2 basis-1/4 bg-gray-300 inline-flex py-3 px-5 rounded-lg items-center ml-4 focus:outline-none hover:bg-yellow-400 hover:text-yellow-900 text-black">
          ...
          <div className="flex my-3">
            <button className="bg-yellow-300 inline-flex py-3 px-5 rounded-lg items-center ml-4 focus:outline-none hover:bg-yellow-400 hover:text-yellow-900 dark:text-yellow-900">
