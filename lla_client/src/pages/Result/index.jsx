    ...
    <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto lg:w-4/5">
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                ...
                <h2 className="title-font font-medium text-3xl text-gray-900">8/10</h2>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                ...
                <h2 className="title-font font-medium text-3xl text-gray-900">100sec</h2>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                ...
                <h2 className="title-font font-medium text-3xl text-gray-900">111</h2>
                <p className="leading-relaxed">Your Rank <span className="font-light text-yellow-600"><sup>★</sup></span></p>
                </div>
            </div>
            </div>
        </div>
