...
const Privacy = () => {
  ...
  return (
    <main className="dark:bg-slate-900 dark:text-white">
      <div className="max-w-4xl p-4 mx-auto privacy-page">
        <h1 className="text-2xl text-center my-2 font-bold">
          LingoMax - Privacy Policy
        </h1>
        <p className="py-1">Last updated: December 22, 2022</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to LingoMax.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to LingoMax, accessible from{" "}
              <a
                href="https://lingomax.ml"
        ...
        <ul>
          <li>By email: taychaudhary1158@gmail.com &nbsp;(Tayyab)</li>
          <li>By email: tchaudhary1158@gmail.com &nbsp;(Tahir)</li>
        </ul>
      </div>
    </main>
  );
